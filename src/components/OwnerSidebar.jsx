...
export default function OwnerSidebar({ activeTab, setActiveTab, isPremium }) {
  return (
    <Sidebar>
      <SidebarHeader className="p-4">
        <div className="flex flex-col items-center text-center mb-6">
          ...
          {isPremium && (
            <Badge
              variant="secondary"
              className="mt-2 bg-amber-100 text-amber-800 hover:bg-amber-100"
            >
              Premium
            </Badge>
          )}
        ...
        {!isPremium && (
          <div className="px-4 py-3 mx-2 mb-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg text-white">
            ...
            <p className="text-xs mt-1 mb-2">
              Acesse relatórios avançados e mais recursos.
            </p>
