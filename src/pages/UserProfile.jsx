...
const UserProfile = () => {
  ...
  const user = {
    id: '1',
    name: 'Nelson Dalva',
    email: 'NelsonDalva@example.com',
    phone: '+244 923 123 456',
    avatar: '/placeholder.svg',
    location: 'Luanda, Angola',
    joinDate: '2024-01-15',
    bio: 'Entusiasta de eventos e festas, sempre em busca de novos espaços incríveis para celebrar momentos especiais. Adoro compartilhar minhas experiências e ajudar outros a encontrar o local perfeito para suas comemorações.',
  };
