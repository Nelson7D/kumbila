...
const BookingPage = () => {
  ...
  const paymentMethods = [
    { id: "espress", name: "Express", icon: "💸", description: "Pagamento via aplicativo Express" },
    { id: "tpa", name: "TPA", icon: "💳", description: "Pagamento com cartão via TPA" },
    { id: "transfer", name: "Transferência Bancária", icon: "🏦", description: "Transferência para conta Bancaria" }
  ];
